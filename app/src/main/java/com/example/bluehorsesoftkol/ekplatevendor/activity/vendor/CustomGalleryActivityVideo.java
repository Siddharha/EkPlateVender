 ...
 */
public class CustomGalleryActivityVideo extends Activity {

    GridView gridGallery;
    Handler handler;
    GalleryAdapterVideo adapter;
    ...
    private void init() {
        ...
        adapter = new GalleryAdapterVideo(getApplicationContext(), imageLoader);
        PauseOnScrollListener listener = new PauseOnScrollListener(imageLoader,
                true, true);
        gridGallery.setOnScrollListener(listener);

        if (action.equalsIgnoreCase(Action.ACTION_MULTIPLE_PICK_VIDEO)) {

            findViewById(R.id.llBottomContainer).setVisibility(View.VISIBLE);
            gridGallery.setOnItemClickListener(mItemMulClickListener);
            adapter.setMultiplePick(true);

        } else if (action.equalsIgnoreCase(Action.ACTION_PICK_VIDEO)) {
